    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <p id="step1"><span id="ldBar" class="text-center"
                ...
                ></span>
                For any custom Functionalities on your software please contact the Dashing Media. <br>
                Thanks for your support !
                <br><br>
                <button type="button" onclick="alert('https://thedashingmedia.com/')"
                        class="update_chart btn btn-primary btn-min-width btn-lg mr-1 mb-1"
                        ><i class="fa fa-download"></i> &nbsp;  Check & Download Update
                </button>
