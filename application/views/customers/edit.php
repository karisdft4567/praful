                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="customergroup" class="form-control" id="customergroup">
                                    <?php
                        ...
                        <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 col-form-label"
                                        for="customergroup"><?php echo 'Customer Sub group'//$this->lang->line('Customer Sub group') ?></label>

                                    <div class="col-sm-6">
                                        <select name="customersubgroup" class="form-control" id="customersubgroup">

                                            <?php
                                            echo '<option value="'.$customersubgroup['id'] . '">' .$customersubgroup['title'].'</option>';
                                            foreach ($customersubgrouplist as $row) {
                                                $cid = $row['id'];
                                                $title = $row['title'];
                                                echo "<option value='$cid'>$title</option>";
                                            }
   ...
   $('#customergroup').change(function(){ 
    ...
    if(len > 0) {
       $.each(response, function(index,subgroup){  
            ...
            {
                $("#customersubgroup").html($("<option></option>", {"value":"", "text":"SelectSelect Sub Group"}));
