...
<head>
    ...
    ?>
    <link rel="apple-touch-icon" href="<?= assets_url() ?>userfiles/company/favicon.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= assets_url() ?>userfiles/company/favicon.png">
