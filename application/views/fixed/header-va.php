                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item">
                            <a href="<?php echo base_url(); ?>clientgroup"><i
                                        class="icon-grid"></i> <?php 
                                       
                                        
                                        echo $this->lang->line('Client Groups'); ?></a>
                             ...
                             <li class="menu-item">
                                    ...
                                    <a
                                            href="<?php echo base_url(); ?>clientgroup"> Client Group List</a>
                                ...
                                <li class="menu-item">
                                    ...
                                    <a
                                            href="<?php echo base_url(); ?>clientsubgroup"> Client Sub Group List</a>
                                            
                                          
                                </li>  
                           
                            <?php
                                    foreach($clgroups_menu as $grmenu)        {
                            ...
                            ?>
                                ...
                                <li class="menu-item">
                                    ...
                                    <a
                                            href="<?php echo base_url(); ?>clientgroup/groupview?id=<?php echo $ids; ?>"><?php echo  $grmenu['title']; ?></a>
                       ...
                       <!-- <li class="menu-item">
                            <a href="<?php echo base_url(); ?>clientsubgroup"><i
                                        class="icon-grid"></i> <?php 
                                       
                                        
                                       // echo $this->lang->line('Client Groups'); 
                                        echo "Client SubGroups"; ?></a>
                            ...
                            <li class="menu-item">
                                    ...
                                    <a
                                            href="<?php echo base_url(); ?>clientsubgroup"> Client SubGroup List</a>
                                            
                                          
                                </li>  
                           
                            <?php
                                    foreach($clsubgroups_menu as $grmenu)        {
                            ...
                            ?>
                                ...
                                <li class="menu-item">
                                    ...
                                    <a
                                            href="<?php echo base_url(); ?>clientsubgroup/groupview?id=<?php echo $ids; ?>"><?php echo  $grmenu['title']; ?></a>
