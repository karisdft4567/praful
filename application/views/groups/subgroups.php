...
use Mpdf\Tag\P;
 ...
 echo  "Client Sub Groups";//$this->lang->line('Client Groups') ?> <a href="<?php echo base_url('clientsubgroup/create') ?>"
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="cgrtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    <tr>
                        <th>#</th>
                        <th><?php  echo "Group Name" //echo $this->lang->line('Name') ?></th>
                        <th><?php echo "Sub Group Name" //echo $this->lang->line('Name') ?></th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="action-url" value="clientsubgroup/delete_i">
