<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo "Add New Client Sub Group";//$this->lang->line('Add New Client Group') ?></h5>
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="group_name"><?php  echo "Sub Group Name"; //echo $this->lang->line('Group Name') ?></label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="submit" id="submit-data" class="btn btn-success margin-bottom"
                                   value="<?php echo "Add SubGroup"; //echo $this->lang->line('Add Group') ?>" data-loading-text="Adding...">
                            <input type="hidden" value="clientsubgroup/add" id="action-url">
                        </div>
                    </div>
