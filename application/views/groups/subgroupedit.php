        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <input type="hidden" name="id" value="<?php echo $subgroup['id'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" name="group_desc" class="form-control required"
                                   ...
                                   value="<?php echo $subgroup['summary'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" value="clientsubgroup/editgroupupdate" id="action-url">
                        </div>
                    </div>
