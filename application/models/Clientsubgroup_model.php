...
class Clientsubgroup_model extends CI_Model
{
    ...
    public function dropdowndetails($id)
    { 
    ...
    public function add($parent_id,$group_name, $group_desc,$loc)
    { 
        $data = array(
            'parent_id' => $parent_id,
            'title' => $group_name,
        ...
        if ($this->db->insert('geopos_cust_subgroup', $data)) { 
    ...
    public function editgroupupdate($gid,$parent_id, $group_name, $group_desc)
    {
        $data = array(
            'parent_id' => $parent_id,
            'title' => $group_name,
        ...
        if ($this->db->update('geopos_cust_subgroup')) {
